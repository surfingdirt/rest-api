 ...
 *
 */
class Lib_Form_Element_UserId extends Lib_Form_Element_Data
{
  /**
   * Autocomplete helper
   *
   ...
   * @var string
   */
  protected $_defaultName = User::INPUT_USERID;
  /**
   * Validator
   *
   * @var string
   */
  protected $_validator = 'Lib_Validate_UserId';
   ...
   * @var string
   */
  protected $_titleColumn = User::COLUMN_USERID;
  /**
