...
class Media_Item_Photo_Form extends Media_Item_Form
{
    ...
    public function getMedia($required = true)
    {
        if($this->_useRemoteFile) {
	    	...
	    	$element = new Lib_Form_Element_File('media', $required, APP_MEDIA_DIR, GLOBAL_UPLOAD_MAXSIZE_PHOTO, array('accept' => Media_Item_Photo::getAllowedMimeTypes()), null, Media_Item_Photo::$allowedMimeTypes);
