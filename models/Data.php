...
abstract class Data extends Cache_Object
{
	 ...
	 * @param boolean $api whether to use the api version of the mapper
	 * @return mixed Data_Row|null
	 */
	public static function factory($itemId, $itemType, $exceptionOnEmpty = false, $api = false)
	{
        if(empty($itemType)){
